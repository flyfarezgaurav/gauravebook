            ...
            $("#bookingRequest").validate({
                ...
                rules: {       
                		    ...
                		    messages: {
                     			...
                     			'paymentDetails.maskCardNumber':{required: 'Please Enter Crad Number'},
                            	'paymentDetails.cardHolderName':{required: 'Please Enter Crad Holder Name'},
