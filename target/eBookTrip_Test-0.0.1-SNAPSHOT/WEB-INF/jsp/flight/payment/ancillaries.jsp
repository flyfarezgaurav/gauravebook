              ...
              <div class="cccdhead"> <img src="/resources/images/icons/web-checking-white.png" alt="Protection"> Web Check-in
                ...
                <div class="pricedropP">
                  <p>Reasons you might need web check-in</p>
                    ...
                    <div class="protection-price-display">
                        <span class="price-display-text">${currencySymbol}<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${9.99*currencyValue}" />
                        ...
                        <div class="itemss ${serviceText.name=='Standard' ? 'active' : ''}">
                            ...
                            <div class="itemssBody">
                                ...
                                <div>
                                    ...
                                    ${currencySymbol}<fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${serviceText.price*currencyValue}" /></a>
                                </div>
                            </div>
                        </div>
