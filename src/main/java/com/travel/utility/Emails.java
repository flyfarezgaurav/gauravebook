...
public class Emails {
	...
	public String buildFlightEmail(BookingRequest bookingRequest, FlightRequest searchRequest){
		...
		buffer.append(""+bookingRequest.getBookingID()+"");
		buffer.append("</td>");
		buffer.append("</tr>");
		buffer.append("<tr>");
		...
		for (int j = 0; j < bookingRequest.getFlightResult().getOutBound().size(); j++) {
			...
			try
			{
				buffer.append("<td style='text-align:center;padding:5px;color:#666666;'><img src='https://www.ebooktrip.com/resources/images/clocko.png' width='14px;' height='14px;'>"+Utility.timeConversion(bookingRequest.getFlightResult().getOutBound().get(j).getEft())+"</td>");
			}catch(Exception e){
		...
		if(searchRequest.getTripType() != 1){
			...
			for (int j = 0; j < bookingRequest.getFlightResult().getInBound().size(); j++) {
				...
				try{
					buffer.append("<td style='text-align:center;padding:5px;color:#666666;'><img src='https://www.ebooktrip.com/resources/images/clocko.png' width='14px;' height='14px;'>"+Utility.timeConversion(bookingRequest.getFlightResult().getInBound().get(j).getEft())+"</td>");
				}catch(Exception e){
					buffer.append("<td style='text-align:center;padding:5px;color:#666666;'></td>");
				}
				buffer.append("<td style='text-align:right;padding:5px;color:#666666;'>"+depToDateStr+","+depToTimeStr+"</td>");
		...
		if(searchRequest.getTripType() == 3)
		{
			for (int j = 0; j < bookingRequest.getFlightResult().getOtherBound().size(); j++) {
				...
				for (int i = 0; i < bookingRequest.getFlightResult().getOtherBound().get(j).size(); i++) {
					...
					try
					{
						buffer.append("<td style='text-align:center;padding:5px;color:#666666;'><img src='https://www.ebooktrip.com/resources/images/clocko.png' width='14px;' height='14px;'>"+Utility.timeConversion(bookingRequest.getFlightResult().getOtherBound().get(j).get(i).getEft())+"</td>");
					}catch(Exception e){
						buffer.append("<td style='text-align:center;padding:5px;color:#666666;'></td>");
					}
		...
		for (int k = 0; k < bookingRequest.getPassengerDetails().size(); k++) {
			...
			buffer.append("<td style='padding:5px;'>"+bookingRequest.getPassengerDetails().get(k).getDobDay()+"-"+getMonthName(bookingRequest.getPassengerDetails().get(k).getDateOfMonth())+"-"+bookingRequest.getPassengerDetails().get(k).getDateOfYear()+"</td>");
			buffer.append("</tr>");
		}
		...
		buffer.append("<td style='padding:5px;text-align:right;'>"+bookingRequest.getCurrencySymbol()+""+format.format((adultTotal*searchRequest.getAdults()*bookingRequest.getCurrencyValue()))+"</td>");
		buffer.append("</tr>");
		...
		buffer.append("<td style='padding:5px;text-align:right;'>"+bookingRequest.getCurrencySymbol()+""+format.format((bookingRequest.getFlightResult().getFare().getAdultFare()+bookingRequest.getFlightResult().getFare().getAdultMarkup()+bookingRequest.getFlightResult().getFare().getAdultTax())*bookingRequest.getCurrencyValue())+"</td>");
		buffer.append("</tr>");
		
		/*
		buffer.append("<tr style='color:#17252A;font-weight:400;font-size:14px;'>");
		buffer.append("<td style='padding:5px;'>Taxes & Fees per adult</td>");
		buffer.append("<td style='padding:5px;text-align:right;'>$"+format.format((bookingRequest.getFlightResult().getFare().getAdultMarkup()+bookingRequest.getFlightResult().getFare().getAdultTax()))+"</td>");
		buffer.append("</tr>");
		*/
		...
		if(searchRequest.getChild() > 0){
			...
			buffer.append("<td style='padding:5px;text-align:right;'>"+bookingRequest.getCurrencySymbol()+""+format.format((searchRequest.getChild()*childTotal*bookingRequest.getCurrencyValue()))+"</td>");
			buffer.append("</tr>");
			buffer.append("<tr style='color:#17252A;font-weight:400;font-size:14px;'>");
			buffer.append("<td style='padding:5px;'>Flight Charges per Child</td>");
			buffer.append("<td style='padding:5px;text-align:right;'>"+bookingRequest.getCurrencySymbol()+""+format.format((bookingRequest.getFlightResult().getFare().getChildFare()+bookingRequest.getFlightResult().getFare().getChildMarkup()+bookingRequest.getFlightResult().getFare().getChildTax())*bookingRequest.getCurrencyValue())+"</td>");
			buffer.append("</tr>");
			
			/*
			buffer.append("<tr style='color:#17252A;font-weight:400;font-size:14px;'>");
			buffer.append("<td style='padding:5px;'>Taxes & Fees per Child</td>");
			buffer.append("<td style='padding:5px;text-align:right;'>$"+format.format((bookingRequest.getFlightResult().getFare().getChildMarkup()+bookingRequest.getFlightResult().getFare().getChildTax()))+"</td>");
			buffer.append("</tr>");
			*/
		...
		if(searchRequest.getInfants() > 0){
			...
			buffer.append("<td style='padding:5px;text-align:right;'>"+bookingRequest.getCurrencySymbol()+""+format.format((searchRequest.getInfants()*infantTotal*bookingRequest.getCurrencyValue()))+"</td>");
			buffer.append("</tr>");
			buffer.append("<tr style='color:#17252A;font-weight:400;font-size:14px;'>");
			buffer.append("<td style='padding:5px;'>Flight Charges per Infant</td>");
			buffer.append("<td style='padding:5px;text-align:right;'>"+bookingRequest.getCurrencySymbol()+""+format.format((bookingRequest.getFlightResult().getFare().getInfantFare()+bookingRequest.getFlightResult().getFare().getInfantMarkup()+bookingRequest.getFlightResult().getFare().getInfantTax())*bookingRequest.getCurrencyValue())+"</td>");
			buffer.append("</tr>");
			
			/*
			buffer.append("<tr style='color:#17252A;font-weight:400;font-size:14px;'>");
			buffer.append("<td style='padding:5px;'>Taxes & Fees per Infant</td>");
			buffer.append("<td style='padding:5px;text-align:right;'>$"+format.format((bookingRequest.getFlightResult().getFare().getInfantMarkup()+bookingRequest.getFlightResult().getFare().getInfantTax()))+"</td>");
			buffer.append("</tr>");
			*/
		...
		if(searchRequest.getInfantsWs() > 0){
			...
			buffer.append("<td style='padding:5px;text-align:right;'>"+bookingRequest.getCurrencySymbol()+""+format.format((searchRequest.getInfantsWs()*infantWsTotal*bookingRequest.getCurrencyValue()))+"</td>");
			buffer.append("</tr>");
			buffer.append("<tr style='color:#17252A;font-weight:400;font-size:14px;'>");
		...
		if(bookingRequest.getTravelGuard().equalsIgnoreCase("Yes")){
			...
			buffer.append("<tr style='color:#17252A;font-weight:550'>");
			buffer.append("<td style='padding:5px;'> Travel Guard Fee </td>");
			buffer.append("<td style='padding:5px;text-align:right;'>"+bookingRequest.getCurrencySymbol()+""+format.format(bookingRequest.getTravelGuardCost())+"</td>");
			buffer.append("</tr>");
		}
		...
		if(bookingRequest.getPriceDropTaken().equalsIgnoreCase("Yes")){
			...
			buffer.append("<td style='padding:5px;text-align:right;'>"+bookingRequest.getCurrencySymbol()+""+format.format(bookingRequest.getPriceDropAmount())+"</td>");
			buffer.append("</tr>");
		}
		...
		if(bookingRequest.getTravelAssistTaken().equalsIgnoreCase("Yes")){
			...
			buffer.append("<td style='padding:5px;text-align:right;'>"+bookingRequest.getCurrencySymbol()+""+format.format(bookingRequest.getTravelAssistAmount())+"</td>");
			buffer.append("</tr>");
		}
			...
			buffer.append("<td style='padding:5px;text-align:right;'>"+bookingRequest.getCurrencySymbol()+""+format.format(bookingRequest.getWebcheckincost())+"</td>");
			buffer.append("</tr>");
		}
		
		if(bookingRequest.getUpgradeTaken().equalsIgnoreCase("Yes")){
			upPrice = bookingRequest.getUpgradeAmount();
			buffer.append("<tr style='color:#17252A;font-weight:550'>");
			buffer.append("<td style='padding:5px;'> Upgrade ("+bookingRequest.getUpgradePlan()+") </td>");
			buffer.append("<td style='padding:5px;text-align:right;'>"+bookingRequest.getCurrencySymbol()+""+format.format(bookingRequest.getUpgradeAmount())+"</td>");
			buffer.append("</tr>");
		}
		...
		buffer.append("<td style='padding:5px;text-align:right;'>"+bookingRequest.getCurrencySymbol()+""+format.format((bookingRequest.getFlightResult().getFare().getGrandTotal()+tgPrice+pdpPrice+taPrice+upPrice+webPrice)*bookingRequest.getCurrencyValue())+"</td>");
		buffer.append("</tr>");
		buffer.append("<tr style='text-align:left;font-size:13px;color:#333;'>");
		buffer.append("<td colspan='2' style='padding:5px;'><b>NOTE:</b> All Fares displayed are quoted in ");
				/*if(bookingRequest.getCurrencyValue() == 1){
		 			buffer.append("USD");
				}
				else{
					buffer.append(""+bookingRequest.getCurrencySymbol()+"");
				}*/
				
				buffer.append(""+bookingRequest.getCurrencySymbol()+" and inclusive of base fare, taxes and all fees. Additional baggage fees may apply as per the airline policies. Fares are not Guaranteed and are subject to change until Tickets are issued.</td>");
		buffer.append("</tr>");
		
		/*buffer.append("<tr style='text-align:left;font-size:13px;color:#333;'>");
		buffer.append("<td colspan='2' style='padding:5px;'>");
		buffer.append(" Please do not make another reservation to avoid any confusion or unnecessary duplicate bookings.");
		buffer.append("</td>");
		buffer.append("</tr>");*/
		...
		buffer.append("</tr>");
		buffer.append("<tr>");
		buffer.append("<td colspan='2' style='text-align:center;padding:3%;color:#17252A;font-size:15px;'>© Copyright 2021-2023 All right Reserved ebooktrip.com</td>");
		buffer.append("</tr>");
		buffer.append("</table>");
		buffer.append("</body>");
		buffer.append("</html>");
