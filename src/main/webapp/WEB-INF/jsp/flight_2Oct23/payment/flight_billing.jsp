...
<html ng-app="flightPayment">
    <head>
		...
		<script src="/resources/scripts/ancillaries.js?Sep302023"></script>
...
.trvlProt .pricedropP p {padding: 0 0 0 20px; margin-top: 20px;}
...
.trvlProt .checkMark li { /* background: url(/resources/images/icons/check-mark.png) top left no-repeat;*/ width:50%; position:relative; padding:0 0 0 25px; background-size:20px; margin:0 0 15px 0;font-size: 14px; }
...
.trvlAsistSec .itemsHeadng ul > li:last-child {background:transparent;}
...
.addRemButSec button#addPdp {color:#fff; background:#063D99; border:1px solid #063D99; padding:8px 15px 8px;}
.addRemButSec button#addPdp i {margin-right: 2px;}
