...
<c:forEach var="inbound" items="${bookingRequest.flightResult.inBound}" varStatus="loop">,{
    ...
    <body><jsp:include page="tag-manager-body.jsp" />
        ...
        <li><a href="/privacy-policy">Privacy Policy</a></li>
            <p>&copy 2023 Ebooktrip.com All Rights Reserved</p> 
        </div>
				...
				<c:if test="${bookingRequest.travelGuard=='Yes'}">
					...
					<div class="person-price">
                    	<div class="tpp">
                    		...
                    		<span>${currencySymbol} <fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${bookingRequest.travelGuardCost}"/></span>
                    	</div>
                    </div>
				</c:if>
				...
				<c:if test="${bookingRequest.priceDropTaken=='Yes'}">
					...
					<div class="person-price">
                    	<div class="tpp">
                    		...
                    		<span>${currencySymbol} <fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${bookingRequest.priceDropAmount}"/></span>
                    	</div>
                    </div>
				</c:if>
				...
				<c:if test="${bookingRequest.travelAssistTaken=='Yes'}">
					...
					<div class="person-price">
                    	<div class="tpp">
                    		...
                    		<span>${currencySymbol} <fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${bookingRequest.travelAssistAmount}"/></span>
                    	</div>
                    </div>
				</c:if>
				...
				<c:if test="${bookingRequest.webcheckin=='Yes'}">
					...
					<div class="person-price">
                    	<div class="tpp">
                    		...
                    		<span>${currencySymbol} <fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${bookingRequest.webcheckincost}"/></span>
                    	</div>
                    </div>
				</c:if>
				...
				<c:if test="${bookingRequest.upgradeTaken=='Yes'}">
					...
					<div class="person-price">
                    	<div class="tpp">
                    		...
                    		<span>${currencySymbol} <fmt:formatNumber type="number" minFractionDigits="2" maxFractionDigits="2" value="${bookingRequest.upgradeAmount}"/></span>
                    	</div>
                    </div>
				</c:if>
