...
<body>
    ...
    <style>
        .error-pagebg
        {
            background-image:url(/resources/images/404-eb.jpg);
        ...
        .error-pagegrad
        {
            /*background:linear-gradient(#063d99,#db2405);*/
            opacity:0.9;
            width:100%;
            height:100%;
        }
        ...
        .error-reason
        {
            font-size:22px; text-shadow:1px 1px black;
        }
        .error-fwd
        {
            margin:10px 0;
        ...
        .unimpbutton
        {
            ...
            color:#fff; border-color:white !important;
        }
        .impbutton:hover
        {
